    ...
    return (
      <Content style={styles.content}>
        <List>
          ...
          <ListItem onPress={() => this.props.navigation.navigate("GameList")}>
            <IconMaterial
          ...
          <ListItem onPress={() => this.props.navigation.navigate("PlayerList")}>
            <IconMaterial
              name="keyboard-arrow-right"
              size={20}
              style={styles.icons}
          ...
          <ListItem onPress={() => this.props.navigation.navigate("TableList")}>
            <IconMaterial
              name="keyboard-arrow-right"
              size={20}
              style={styles.icons}
