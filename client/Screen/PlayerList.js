...
class PlayerList extends Component {
  ...
  deleteRow(secId, rowId, rowMap, data) {
    let that = this;
    this.props.actionsPlayer.deletePlayer(data._id).then(() => {
        ...
        <Header>
          ...
          <Right>
            <Button
              transparent
              name="menu"
              onPress={() => this.props.navigation.navigate("PlayerEdit")}
            >
              <Text>Add</Text>
            </Button>
          </Right>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <ListItem
                noIndent
                onPress={() =>
                  this.props.navigation.navigate("PlayerEdit", {
                    id: item._id
                  })
                }
              >
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.PlayerListReducer.listPlayer
  };
}
