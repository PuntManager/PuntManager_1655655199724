...
class GameList extends Component {
  ...
  componentWillMount() {
    this.props.navigation.addListener("willFocus", async () => { 
      ...
      // Load list
      this.props.actionsGame.loadGameList();
    });
  }
  ...
  deleteRow(secId, rowId, rowMap, data) {
    let that = this;
    this.props.actionsGame.deleteGame(data._id).then(() => {
        ...
        <Header>
          ...
          <Right>
            <Button
              transparent
              name="menu"
              onPress={() => this.props.navigation.navigate("GameEdit")}
            >
              <Text>Add</Text>
            </Button>
          </Right>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <ListItem
                noIndent
                onPress={() =>
                  this.props.navigation.navigate("GameEdit", {
                    id: item._id
                  })
                }
              >
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.GameListReducer.listGame
  };
}
